...
while T > 0:
    ...
    # print("first_rate : " + str(first_rate) + "," + "final_rate : " + str(final_rate))
    
    ans1 = (n * (first_rate + final_rate) * d) // 2
    
    # print("ans 1 : " + str(ans1))
    
    rem_days = D % d
    rem_rate = final_rate + Q
    
    # print("rem_days : " + str(rem_days) + " " + "rem_rate : " + str(rem_rate))
    
    ans2 = rem_rate * rem_days
